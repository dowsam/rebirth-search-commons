...
import cn.com.rebirth.search.commons.inject.internal.MatcherAndConverter;
import cn.com.rebirth.search.commons.inject.internal.Scoping;
import cn.com.rebirth.search.commons.inject.internal.SourceProvider;
import cn.com.rebirth.search.commons.inject.internal.ToStringBuilder;
...
import cn.com.rebirth.search.commons.inject.util.Providers;
...
class InjectorImpl implements Injector, Lookups {
	...
	<T> BindingImpl<T> createProvidedByBinding(Key<T> key, Scoping scoping, ProvidedBy providedBy, Errors errors)
		...
		return new LinkedProviderBindingImpl<T>(this, key, rawType , Scopes.<T> scope(key, this,
				internalFactory, scoping), scoping, providerKey);
	}
	...
	<T> BindingImpl<T> createImplementedByBinding(Key<T> key, Scoping scoping, ImplementedBy implementedBy,
		...
		return new LinkedBindingImpl<T>(this, key, rawType , Scopes.<T> scope(key, this, internalFactory,
