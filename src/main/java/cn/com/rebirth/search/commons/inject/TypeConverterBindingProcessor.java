 ...
 * Info:summall-search-commons TypeConverterBindingProcessor.java 2012-3-29 15:15:13 l.xue.nong$$
 */
...
import cn.com.rebirth.search.commons.inject.matcher.AbstractMatcher;
import cn.com.rebirth.search.commons.inject.matcher.Matcher;
import cn.com.rebirth.search.commons.inject.matcher.Matchers;
import cn.com.rebirth.search.commons.inject.spi.TypeConverter;
import cn.com.rebirth.search.commons.inject.spi.TypeConverterBinding;
...
class TypeConverterBindingProcessor extends AbstractProcessor {
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.commons.inject.AbstractProcessor#visit(cn.com.summall.search.commons.inject.spi.TypeConverterBinding)
	 */
	@Override
